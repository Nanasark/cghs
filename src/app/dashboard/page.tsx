...
//  <TransactionsSection kybStatus={kybStatus} onBalanceUpdate={handleBalanceUpdate} />              <TransactionsCard
...
export default function Dashboard() {
 ...
 const response = await balanceOf({
  ...
  // Handle balance update after transactions
  const handleBalanceUpdate = () => {
    fetchBalance()
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "transactions" && (
          <div className="space-y-6">
            {/* Add the TransactionsSection at the top of the transactions tab */}
            <TransactionsSection kybStatus={kybStatus} onBalanceUpdate={handleBalanceUpdate} />
