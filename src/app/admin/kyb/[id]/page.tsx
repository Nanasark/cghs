...
// // Next.js 15.2 compatible page component with async params
// export default async function KYBApplicationDetailPage({
//   params,
// }: {
//   params: Promise<{ id: string }>
// }) {
//   // We need to await the params to get the id
//   const { id } = await params

//   // Since we're using "use client" and need to use hooks, we need to create a client component
//   return <KYBApplicationDetail id={id} />
// }

// // Client component that handles state and effects
// function KYBApplicationDetail({ id }: { id: string }) {
...
//       try {
//         const response = await fetch(`/api/admin/kyb-applications/${id}`)
